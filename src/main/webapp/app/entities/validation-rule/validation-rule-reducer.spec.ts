...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_VALIDATIONRULE_LIST actions', async () => {
    ...
    it('dispatches FETCH_VALIDATIONRULE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_VALIDATIONRULE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_VALIDATIONRULE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_VALIDATIONRULE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_VALIDATIONRULE actions', async () => {
      const expectedActions = [
        {
