...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './submission-result.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_SUBMISSIONRESULT_LIST actions', async () => {
    ...
    it('dispatches FETCH_SUBMISSIONRESULT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_SUBMISSIONRESULT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_SUBMISSIONRESULT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_SUBMISSIONRESULT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_SUBMISSIONRESULT actions', async () => {
      const expectedActions = [
        {
