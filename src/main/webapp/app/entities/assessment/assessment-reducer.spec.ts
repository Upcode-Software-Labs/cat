...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_ASSESSMENT_LIST actions', async () => {
    ...
    it('dispatches FETCH_ASSESSMENT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_ASSESSMENT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_ASSESSMENT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_ASSESSMENT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_ASSESSMENT actions', async () => {
      const expectedActions = [
        {
