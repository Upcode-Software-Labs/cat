...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_USERASSESSMENT_LIST actions', async () => {
    ...
    it('dispatches FETCH_USERASSESSMENT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_USERASSESSMENT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_USERASSESSMENT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_USERASSESSMENT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_USERASSESSMENT actions', async () => {
      const expectedActions = [
        {
