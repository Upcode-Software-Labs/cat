  ...
  return (
    <div>
      <h2 id="audit-log-heading" data-cy="AuditLogHeading">
        <Translate contentKey="catApp.auditLog.home.title">Audit Logs</Translate>
        <div className="d-flex justify-content-end">
          <Button className="me-2" color="info" onClick={handleSyncList} disabled={loading}>
            <FontAwesomeIcon icon="sync" spin={loading} />{' '}
            <Translate contentKey="catApp.auditLog.home.refreshListLabel">Refresh List</Translate>
          </Button>
          <Link to="/audit-log/new" className="btn btn-primary jh-create-entity" id="jh-create-entity" data-cy="entityCreateButton">
            <FontAwesomeIcon icon="plus" />
            &nbsp;
            <Translate contentKey="catApp.auditLog.home.createLabel">Create new Audit Log</Translate>
          </Link>
        </div>
      </h2>
        ...
        {auditLogList && auditLogList.length > 0 ? (
            ...
            <thead>
              <tr>
                <th className="hand" onClick={sort('id')}>
                  <Translate contentKey="catApp.auditLog.id">ID</Translate> <FontAwesomeIcon icon={getSortIconByFieldName('id')} />
                </th>
                ...
                <th>
                  <Translate contentKey="catApp.auditLog.user">User</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th />
              </tr>
            </thead>
          ...
          !loading && (
            <div className="alert alert-warning">
              <Translate contentKey="catApp.auditLog.home.notFound">No Audit Logs found</Translate>
            </div>
          )
        )}
      </div>
