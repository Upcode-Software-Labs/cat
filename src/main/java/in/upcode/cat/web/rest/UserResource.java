...
import in.upcode.cat.config.Constants;
import in.upcode.cat.domain.User;
import in.upcode.cat.repository.UserRepository;
import in.upcode.cat.security.AuthoritiesConstants;
import in.upcode.cat.service.MailService;
import in.upcode.cat.service.UserService;
import in.upcode.cat.service.dto.AdminUserDTO;
import in.upcode.cat.web.rest.errors.BadRequestAlertException;
import in.upcode.cat.web.rest.errors.EmailAlreadyUsedException;
import in.upcode.cat.web.rest.errors.LoginAlreadyUsedException;
 ...
 * <p>
 * This class accesses the {@link in.upcode.cat.domain.User} entity, and needs to fetch its collection of authorities.
 * <p>
